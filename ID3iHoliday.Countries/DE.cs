    ...
    public class DE : Country
    {
        public DE()
        {
            ...
            Rules = new ListRule()
            {
                ...
                new Rule()
                {
                    Expression = ExpressionTree.Date.Catholic.CarnivalTuesday.Start("14:00"),
                ...
                new Rule()
                {
                    ...
                    Type = Bank,
                    Note ="Pour l'instant aucun pattern ne supporte : DATE 12-24 14:00 IF SUNDAY THEN 00:00"
                },
                new Rule()
                {
