...
namespace ShaNetHoliday.Syntax.Composition
{
    ...
    /// </summary>
    public class After : ExpressionElement
    {
        /// <summary>
        /// Token de l'élément.
        /// </summary>
        ...
        /// <summary>
        /// Initialise une nouvelle instance de la classe <see cref="After"/>.
        /// </summary>
        /// <param name="parent">Elément de syntax parent.</param>
        /// <param name="value">Date.</param>
        public After( ExpressionElement parent, string value ) : base( parent ) => Value = value;
